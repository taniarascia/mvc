  ...
  _createClass(View, [{
    ...
    value: function bindEvents(controller) {
      ...
      this.form.addEventListener('submit', function (event) {
        ...
        controller.handleAddTodo(_this2.todoText);
      ...
      this.todoList.addEventListener('focusout', function (event) {
        if (_this2.temporaryEditValue) {
          var id = parseInt(event.target.parentElement.id);
          controller.handleEditTodoComplete(id, _this2.temporaryEditValue);
...
var Controller = function Controller(model, view) {
  ...
  _defineProperty(this, "onTodoListChanged", function (todos) {
    _this3.view.displayTodos(todos);
  });

  _defineProperty(this, "handleAddTodo", function (todoText) {
    _this3.model.addTodo(todoText);
  });

  _defineProperty(this, "handleEditTodoComplete", function (id, todoText) {
    _this3.model.editTodo(id, todoText);
  });

  _defineProperty(this, "handleDeleteTodo", function (id) {
    _this3.model.deleteTodo(id);
  });

  _defineProperty(this, "handleToggle", function (id) {
    _this3.model.toggleTodo(id);
  });

  this.model = model;
  this.view = view;
  this.model.bindEvents(this);
  this.view.bindEvents(this); // Display initial todos
